    ...
    <section className="relative py-0">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-6xl mx-auto -mt-8 lg:-mt-12 relative z-20">
          <div className="relative bg-gradient-to-br from-[#12133A] via-[#191B4A] to-[#272A75] rounded-2xl lg:rounded-3xl border border-white/[0.06] p-8 lg:p-12 shadow-2xl shadow-black/40 overflow-hidden">
            {/* Inner glow */}
